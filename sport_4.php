            ...
            <div class="content">
                ...
                <div class="container">
                    <div class="row element_center font" style="margin-top: 2%; font-size: 25px;">
                            ...
                            <!-- 添加隱藏的表單 -->
                            <form id="timeForm" action="save_time_4.php" method="POST" style="display: none;">
                        ...
                        <div class="col-4">
                            <div class="row element_center font" style="border: 5px solid #9dbfbb; border-radius:20px; background-color:#9dbfbb;">
                                ...
                                <p class="row element_center" style="font-size: 20px;">
                                    上跳時，雙腳向外張開，雙手高舉過頭到接近頭頂正上方的位置。雙手雙腳打直，膝蓋不彎曲。落地時，從腳尖落地，膝蓋微彎，減少衝擊力。雙腳和雙手回到原位。
                                </p>
                                <p class="row element_center" style="">
                                    <iframe width="160" height="200" 
                                        src="https://www.youtube.com/embed/cwuZygxEhRk" title="YouTube video player" frameborder="0" 
