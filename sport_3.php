            ...
            <div class="content">
                ...
                <div class="container">
                    <div class="row element_center font" style="margin-top: 2%; font-size: 25px;">
                            ...
                            <!-- 添加隱藏的表單 -->
                            <form id="timeForm" action="save_time_3.php" method="POST" style="display: none;">
                        ...
                        <div class="col-4">
                            <div class="row element_center font" style="border: 5px solid #9dbfbb; border-radius:20px; background-color:#9dbfbb;">
                                ...
                                <p class="row element_center" style="font-size: 20px;">
                                    雙腳分開與肩同寬站立，並維持脊椎垂直地面。原地往上跳起並保持腿部伸直核心出力保持身體穩定、保持平衡，確保起跳跟落地在同一點，重複同樣的步驟。
                                </p>
                                <p class="row element_center" style="">
                                    <iframe width="160" height="200" 
                                        src="https://www.youtube.com/embed/16nIMOoC5I0" title="YouTube video player" frameborder="0" 
