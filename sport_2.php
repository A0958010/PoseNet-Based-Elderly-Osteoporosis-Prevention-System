            ...
            <div class="content">
                ...
                <div class="container">
                    <div class="row element_center font" style="margin-top: 2%; font-size: 25px;">
                            ...
                            <!-- 添加隱藏的表單 -->
                            <form id="timeForm" action="save_time_2.php" method="POST" style="display: none;">
                        ...
                        <div class="col-4">
                            <div class="row element_center font" style="border: 5px solid #9dbfbb; border-radius:20px; background-color:#9dbfbb;">
                                ...
                                <p class="row element_center" style="font-size: 20px;">
                                    雙腳分開與肩同寬站立，並維持脊椎垂直地面。將左膝或右膝（依個人習慣）向上抬至與臀部平行處或踢屁股的動作。當雙腳著地時，抬起另一條腿，重複同樣的步驟。
                                </p>
                                <p class="row element_center" style="">
                                    <iframe width="160" height="200" 
                                        src="https://www.youtube.com/embed/lMiCZqbJkPM" title="YouTube video player" frameborder="0" 
